...
- 💻 **Languages**: C#, Python, SQL, Bash and Basic Level: Lua, JavaScript, PowerShell
- ☁️ **Cloud**: Azure 
- 🔧 **DevOps**: Docker, Kubernetes, Jenkins, Ansible, Argo CD, GitOps, CI/CD
...
- **Technologies**: C#, Unity, Project Management
